...
HealthManaStatus::HealthManaStatus(Scene *scene, GameOverlay *gameOverlay) :
	...
	m_heartSprite(Game::GetInstance()->getResourceManager()->get<Texture2D>("Sprites/Gui/GameOverlay/Heart.png")),
	m_manaSprite(Game::GetInstance()->getResourceManager()->get<Texture2D>("Sprites/Gui/GameOverlay/Mana.png")),
	m_heartTime(0.0f)
{
