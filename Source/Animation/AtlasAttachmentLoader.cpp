...
RegionAttachment *AtlasAttachmentLoader::getAttachment(const string &name)
{
	spAttachment *attachment = spAttachmentLoader_newAttachment(SUPER(m_self), 0, SP_ATTACHMENT_REGION, "Right_Hand_Equip", "Pickaxe_Iron");
	spRegionAttachment *regionAttachment = SUB_CAST(spRegionAttachment, attachment);
	spAtlasRegion *atlasRegion = spAtlas_findRegion(m_atlas, "Pickaxe_Iron");
