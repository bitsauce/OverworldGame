...
void BlockData::init()
{
	...
	s_blockData[BLOCK_WOOD_OAK] = new BlockData(BLOCK_WOOD_OAK, ResourceManager::get<Texture2D>(":/Sprites/Blocks/Empty.png"), ITEM_OAK_BLOCK, 0.75f);
	s_blockData[BLOCK_LEAF] = new BlockData(BLOCK_LEAF, ResourceManager::get<Texture2D>(":/Sprites/Blocks/Empty.png"), ITEM_LEAF_BLOCK, 0.0f);
	s_blockData[BLOCK_DIRT_BACK] = new BlockData(BLOCK_DIRT_BACK, ResourceManager::get<Texture2D>(":/Sprites/Blocks/Empty.png"), ITEM_STONE_BLOCK, 0.95f);
	...
	s_blockData[BLOCK_DIRT_BACK] = new BlockData(BLOCK_DIRT_BACK, ResourceManager::get<Texture2D>(":/Sprites/Blocks/DirtBack.png"), ITEM_STONE_BLOCK, 0.95f);
	s_blockData[BLOCK_STONE] = new BlockData(BLOCK_STONE, ResourceManager::get<Texture2D>(":/Sprites/Blocks/Stone.png"), ITEM_STONE_BLOCK, 1.0f);*/
