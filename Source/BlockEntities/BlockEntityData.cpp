...
{
	s_data[BLOCK_ENTITY_NULL] = new BlockEntityData(BLOCK_ENTITY_NULL, "NULL", Pixmap(), 1, 1, 1, function<BlockEntity*(World*, const int, const int, const BlockEntityData*)>());
	s_data[BLOCK_ENTITY_TORCH] = new BlockEntityData(BLOCK_ENTITY_TORCH, "Torch", Pixmap("Sprites/BlockEntities/LightSources/Torch_anim.png", true), 1, 1, 3, Torch::Factory);
