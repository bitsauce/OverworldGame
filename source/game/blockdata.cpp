...
void BlockData::init()
{
	...
	s_blockData[BLOCK_WOOD] = BlockData(BLOCK_WOOD, xd::ResourceManager::get<xd::Texture2D>(":/sprites/blocks/oak_bark.png"), ITEM_OAK_BLOCK, 0.75f);
	...
	s_blockData[BLOCK_STONE] = BlockData(BLOCK_STONE, xd::ResourceManager::get<xd::Texture2D>(":/sprites/blocks/dirt_bg.png"), ITEM_STONE_BLOCK, 0.95f);
