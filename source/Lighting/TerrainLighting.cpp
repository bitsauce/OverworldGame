...
TerrainLighting::TerrainLighting(Terrain *terrain) :
	GameObject(DRAW_ORDER_TERRAIN_LIGHTING),
	m_terrain(terrain),
...
void TerrainLighting::draw(xd::SpriteBatch *spriteBatch)
{
...
void TerrainLighting::resizeEvent(uint width, uint height)
{
